...
<div class="col-md-12">
        ...
        <div class="col-md-4 mb-4 ">
                        ...
                        <div class="col-md-4 mb-4 contracts"></div>
        </div>
    </div>
<div class="col-md-6">
...
<h1>Add Received Payment</h1>
    ...
    <label for="">Received Amount <a id="amount_info"></a> </label>
...
$('.org').on('change',function(){
    ...
    $.ajax({
        type:'post',
        url:'ajax/ajax.php?action=get_contract_only',
        data:data,
...
$(document).on('change','#contract',function(){
    ...
    $.ajax({
        type:'post',
        url:'ajax/ajax.php?action=get_bill_list',
        data:data1,
        success:function(response1){
            // alert(response1);
            $('.bill_list').html(response1);
        }
    })
});
