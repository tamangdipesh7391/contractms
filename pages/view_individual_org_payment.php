...
<?php if (isset($_SESSION['success'])) { ?>
    ...
    <?php }  ?>
<div class="col-md-12"><h1>Payments of <?=$orgname[0]['org_name'];?></h1>
</div>
    <?php if($bill_data){ ?>
<table class="table table-bordered">
    ...
    <?php foreach($bill_data as $key=>$value) : ?>
        <tr>
            ...
            <td>
                <a href="<?=base_url('edit_payment'); ?>?org_id=<?=$_GET['org_id'];?>&bill_id=<?=$_GET['bid'];?>&pid=<?=$value['pid'];?>" class="btn btn-warning ">Edit</a>
            </td>
